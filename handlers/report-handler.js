...
// ✅ هذه هي الدالة التي كانت ناقصة عندك
function hasReportPermission(sql, member) {
    ...
    // إذا لم يتم تحديد قناة سجلات، نعتبر النظام غير مفعل أو لا توجد قيود صارمة
    ...
    // إذا لم يتم تحديد رتب معينة، فالجميع مسموح لهم
...
module.exports = {
    getReportSettings,
    hasReportPermission, // ✅ الآن موجودة
    sendReportError,
    processReportLogic,
    checkUnjailTask
};
