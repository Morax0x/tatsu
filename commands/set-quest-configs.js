    ...
    async execute(message, args) {
        ...
        if (isSlash) {
            ...
            switch (subcommand) {
                ...
                case 'رسالة-الشجرة':
                    method = 'treemessage';
                    value = interaction.options.getString('id-الرسالة');
                    break;
                case 'قناة-العد':
                    method = 'countchannel';
                    value = interaction.options.getChannel('القناة').id;
        ...
        if (!value) {
            return replyError("يرجى تحديد قيمة (ID).");
        }
        ...
        switch (method) {
            ...
            case 'treemessage':
                ...
                successMessage = `✅ تم تحديد رسالة الشجرة للمراقبة: \`${value}\``;
                break;
            case 'countchannel':
            ...
            case 'questchannel':
                ...
                break;
            default:
                return replyError("أمر غير معروف. استخدم `/اعدادات-المهمات-الخاصة` أو `-sqc` لعرض المساعدة.");
        }
